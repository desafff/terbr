...
mkdir /home/user/123
cd /home/user/123
wget https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/cuda-v0.2.5-hotfix2/aleo_prover-v0.2.5_cuda_lite_hotfix2.tar.gz
tar -xzvf aleo_prover-v0.2.5_cuda_lite_hotfix2.tar.gz
